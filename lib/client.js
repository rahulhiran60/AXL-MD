...
try {
    ...
    console.log("🌍 Connected to the A-X-L DB")
} catch {
    console.log("Could not connect with Mongodb please provide accurate uri. check A-X-L MD GITHUB for more inofo!")
    process.exit(0)
}
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/A-J-S-A-L-S-P-A-R-K-Y/AXL-MD/wiki ')
	}
    }
    main()
    //========================================================================================================================================
